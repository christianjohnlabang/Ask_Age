...
if(test <15) console.log("After" +increment + "years:I dont have to think about my life yet");
    

else if(test >15 && test <30){
    console.log("After" +increment + "years:Need to finish studies and find job");
    ...
    console.log("After" +increment + "years:Prepare to die");
}
else {
